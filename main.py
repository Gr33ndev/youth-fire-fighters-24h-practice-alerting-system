...
def resize_images():
    ...
    new_jf_logo_resized = jf_logo.resize((jf_logo_new_width, jf_logo_new_height), Image.LANCZOS)
    ...
    new_as2_logo_resized = as2_logo.resize((as2_logo_new_width, as2_logo_new_height), Image.LANCZOS)
